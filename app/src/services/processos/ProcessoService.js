...
const { create, getAll, getById } = require("../../persistencia/models/Processos")
const { getAllByKeyValue: TarefaGetByKey, createTarefa } = require("../../persistencia/models/ProcessosTarefas")
const { getByProcessoId: PrecedenteGetByKey, createPrecedente } = require("../../persistencia/models/ProcessosPrecedentes")
const { getByProcessoId: EquipaGetByKey, createEquipa } = require("../../persistencia/models/ProcessosEquipa")
